...
// using an async function so "await" is available
async function init() {
  ...
  async function commit() {
    ...
    // proceed to next row for user to guess another word
    currentRow++;
    currentGuess = "";
    
    // determind if user has won or lost the game
    if (allRight) {
      // win
      alert("you win");
  ...
  // listen on keydown to catch Enter and Backspace
...
// an object out of it (like {E: 2, L: 1, T: 1}) to
// make sure the correct amount of letters marked close instead
